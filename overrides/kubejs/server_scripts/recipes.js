...
//等价交换
    ...
    event.remove({id:'projecte:dark_matter_alt'})
    event.custom({
    ...
    event.shaped('projecte:condenser_mk2',[
        'ABA',
        'BCB',
        'ABA'
    ],{
    ...
    event.custom({
        ...
        "result": {
            ...
            "count": 1,
            "nbt": "{author:\"Shiroha23\",filtered_title:\"Thanks\",pages:[\u0027{\"text\":\"感谢您的游玩！\\\\nThank you for playing!\\\\n遊んでくれてありがとう!\"}\u0027],resolved:1b,title:\"Thanks\"}"
        }
    })

    event.shapeless('projecte:tome',['projecte:philosophers_stone', Item.of('minecraft:written_book', '{author:"Shiroha23",filtered_title:"Thanks",pages:[\'{"text":"感谢您的游玩！\\\\nThank you for playing!\\\\n遊んでくれてありがとう!"}\'],resolved:1b,title:"Thanks"}')])
